...
/** Trien khai du lieu demo, chi duoc nap khi che do demo duoc bat ro rang. */

import type { Goal, GoalStatus, User } from "@/lib/domain/types";
...
import type { GoalFilter, GoalInput, GoalUpdateInput } from "./goals";
